        ...
        <header class="sticky top-0 z-40 border-b border-gray-200 bg-white/80 backdrop-blur">
            <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8" aria-label="Primary">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('logo.png') }}" alt="FeeAdmin Logo" class="h-10 w-auto">
                    <div>
                ...
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid gap-10 lg:grid-cols-2 lg:items-center">
                        <div>
                            ...
                            <p class="mt-3 text-gray-600">
                                Get full access for <span class="font-semibold text-gray-900">{{ $trialDays }} days</span>. No credit card required.
                            </p>
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-gray-50 p-6">
                            ...
                            @if($tutorialUrl)
                                <div class="mt-6 rounded-xl border border-gray-200 bg-white p-4">
                                    ...
                                    <a href="{{ $tutorialUrl }}" class="mt-2 inline-flex items-center text-sm font-semibold hover:opacity-80" style="color: var(--primary-blue);">
                                        Watch setup video
                    ...
                    <div class="mt-10 grid gap-6 lg:grid-cols-2">
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white p-6">
                            ...
                            <p class="mt-2 text-sm text-gray-600">
                                @if($supportEmail)
                                    Email: <span class="font-semibold text-gray-900">{{ $supportEmail }}</span>
                                @else
                                    Support contact can be configured by the superuser.
                                @endif
                                @if($supportPhone)
                                    <span class="ml-2">Phone: <span class="font-semibold text-gray-900">{{ $supportPhone }}</span></span>
                                @endif
                            </p>
                        </div>
                    </div>
        ...
        <footer class="border-t border-gray-200 bg-white">
            <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 border-t border-gray-200 pt-6 text-sm text-gray-600">
                    <p>&copy; {{ date('Y') }} FeeAdmin. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
